...
class TweetCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        infoLabel.text = "Dimash Altynbek @Dimoon"
        ...
        underlineView.anchor(left: leftAnchor, right: rightAnchor, height: 1)
    }
    ...
    @objc func handleLikeButton() {
        delegate?.handleLikeButton(self)
    }
    ...
    func configure() {
        ...
        captionLabel.text = tweet.caprionID
        
        
        profileImageView.sd_setImage(with: TweetModel.profileImage)
        infoLabel.attributedText = TweetModel.userInfoText
    }
}
